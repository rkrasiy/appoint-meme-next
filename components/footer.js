export default function Footer() {
  return (
<footer aria-label="Site Footer" className="bg-white border-t-8 border-[var(--color-principal)] rounded-b-xl">
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center text-[var(--color-principal)] sm:justify-start">
          <svg
            className="h-8"
            viewBox="0 0 118 24"
            fill="none"
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="text-[var(--color-secundario)] transition hover:text-[var(--color-secundario)]/75"
            >
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-500">
          ...
          <a
            className="inline-block text-[var(--color-principal)] underline transition hover:text-[var(--color-principal)]/75"
            href="/"
          >
            Terms & Conditions
          </a>
