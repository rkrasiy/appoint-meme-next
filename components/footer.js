...
<footer aria-label="Site Footer" class="bg-white">
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center text-[var(--color-principal)] sm:justify-start">
          <svg
            class="h-8"
            viewBox="0 0 118 24"
            fill="none"
        ...
        <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            <a
              ...
              rel="noreferrer"
              target="_blank"
              class="text-[var(--color-secundario)] transition hover:text-[var(--color-secundario)]/75"
            >
    ...
    <div class="mt-12 border-t border-gray-100 pt-6">
      <div class="text-center sm:flex sm:justify-between sm:text-left">
        <p class="text-sm text-gray-500">
          ...
          <a
            class="inline-block text-[var(--color-principal)] underline transition hover:text-[var(--color-principal)]/75"
            href="/"
          >
            Terms & Conditions
          </a>
